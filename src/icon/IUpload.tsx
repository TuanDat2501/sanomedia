...
const IUpload = ({height,width}:Props) => {
    return (
            <svg height={height ||'12px'} width={width||'12px'} viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 fill="#fff">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path
                        ...
                        fill="#fff"></path>
                    <path d="M692.9 636.1h-22.6L519.8 485.6v449.6h-16V485.8L353.4 636.1h-22.6l181-181z"
                          fill="#E73B37"></path>
                </g>
            </svg>
    );
