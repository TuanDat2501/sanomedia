...
const ILocate = ({height,width,color}:props) => {
    return (
        <svg fill={color || "#fff"} height={height ||50} width={width||50} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
             contentScriptType="text/ecmascript" contentStyleType="text/css" enableBackground="new 0 0 2048 2048"
              id="Layer_1" preserveAspectRatio="xMidYMid meet" version="1.1" viewBox="0.0 0 1024.0 2048"
