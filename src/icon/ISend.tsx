        ...
        <div>
            <svg fill={hover ? "#FF5454" : "#fff"} height={height ||'12px'} width={width||'12px'} version="1.1" id="Capa_1"
                ...
                <g id="SVGRepo_iconCarrier"> <g id="XMLID_51_"> <path id="XMLID_53_"
                    ...
                    <path id="XMLID_52_"
                          d="M492.431,32.443c-1.513-1.395-3.466-2.125-5.44-2.125c-1.19,0-2.377,0.264-3.5,0.816L7.905,264.422 c-4.861,2.389-7.937,7.353-7.904,12.783c0.033,5.423,3.161,10.353,8.057,12.689l125.342,59.724l250.62-205.99L164.455,364.414 l156.145,74.4c1.918,0.919,4.012,1.376,6.084,1.376c1.768,0,3.519-0.322,5.186-0.977c3.637-1.438,6.527-4.318,7.97-7.956 L494.436,41.257C495.66,38.188,494.862,34.679,492.431,32.443z"></path> </g> </g></svg>
        </div>
    );
};
