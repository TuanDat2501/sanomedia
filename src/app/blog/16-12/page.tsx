    ...
    <div style={{
      ...
      <main>
        <section className="blog-container">
          ...
          <p>
            Một khởi đầu vui vẻ cho tu
            ần mới có thể làm nên điều kỳ diệu cho tinh thần của nhân viên. Tham gia vào các trò chơi nhẹ nhàng giúp phá vỡ sự đơn điệu, giảm căng thẳng và duy trì động lực làm việc.
          </p>
          <br />
