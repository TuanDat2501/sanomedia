...
const Training = () => {
    ...
    return (
        <div style={{maxWidth: "1200px",marginLeft: "auto",marginRight: "auto", marginTop: "100px",marginBottom: "100px",padding:"15px"}}>
            ...
            <Image width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image1.jpg" alt="image1"/>
            ...
            <Image alt="image" width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image2.jpg"/>
            <Image alt="image"  width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image3.jpg"/>
            ...
            <Image alt="image"  width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image4.jpg"/>
            <Image alt="image"  width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image8.jpg"/>
            <div className="paragraph">
            ...
            <div className="paragraph">
                ...
                <Image alt="image"  width={isMobile ? 430 :1000} height={isMobile ? 430 :1000} quality={100} style={{maxWidth: "1200px"}} src="../image/training/image5.jpg"/>
                <div className="paragraph">
